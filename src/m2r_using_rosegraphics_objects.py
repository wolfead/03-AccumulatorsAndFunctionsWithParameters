...
#        necessary?  Why?
#            when you want to look at the picture you created. Because if you leave this out, the window will
#            immediately close once the code has been executed
#
